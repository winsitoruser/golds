      ...
      <main className="pt-24 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 max-w-7xl">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-amber-500/10 rounded-full mb-6 border border-amber-500/20 backdrop-blur-sm">
              <div className="w-2 h-2 bg-amber-500 rounded-full animate-pulse"></div>
              <span className="text-xs text-amber-400 font-medium tracking-widest uppercase">Blockchain Staking</span>
            </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
            <div className="group relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50 hover:border-amber-500/50 transition-all duration-300">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/0 to-amber-500/0 group-hover:from-amber-500/10 group-hover:to-transparent rounded-2xl transition-all duration-300"></div>
            ...
            <div className="group relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50 hover:border-yellow-500/50 transition-all duration-300">
              <div className="absolute inset-0 bg-gradient-to-br from-yellow-500/0 to-yellow-500/0 group-hover:from-yellow-500/10 group-hover:to-transparent rounded-2xl transition-all duration-300"></div>
              <div className="relative">
                <div className="flex items-center justify-between mb-3">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
                ...
                {stakingPools.map((pool) => (
                  ...
                  >
                    <div className={`absolute inset-0 bg-gradient-to-br rounded-2xl transition-all duration-300 ${
                      selectedPool === pool.id ? 'from-amber-500/10 to-transparent' : 'from-transparent to-transparent group-hover:from-gray-700/10'
                    }`}></div>
                    ...
                    <div className="relative">
                      ...
                      <h3 className="text-lg font-bold text-white mb-2 group-hover:text-amber-100 transition-colors">{pool.name}</h3>
            ...
            <div className="lg:col-span-1">
              <div className="relative bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50 sticky top-24">
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="0.00"
                      className="w-full px-4 py-4 bg-gray-900/70 border border-gray-700 rounded-xl text-white text-lg font-semibold focus:outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 transition-all"
                    />
                    <button className="absolute right-3 top-1/2 -translate-y-1/2 px-3 py-1 bg-amber-600 hover:bg-amber-700 text-white text-xs font-bold rounded-lg transition-colors">
                      MAX
                    </button>
                  </div>
                ...
                <div className="grid grid-cols-4 gap-2 mb-6">
                  {[25, 50, 75, 100].map((percent) => (
                    <button
                      ...
                      className="py-2.5 bg-gray-800/50 hover:bg-amber-600/20 border border-gray-700 hover:border-amber-500/50 rounded-lg text-xs font-semibold transition-all hover:text-amber-300"
                    >
                      {percent}%
                    </button>
                  ))}
                ...
                {/* Rewards Estimation */}
                <div className="mb-6 p-5 bg-gradient-to-br from-amber-900/20 to-amber-800/10 border border-amber-500/20 rounded-xl backdrop-blur-sm">
                ...
                <button className="w-full py-4 bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white rounded-xl font-bold transition-all hover:shadow-xl hover:shadow-amber-500/30 flex items-center justify-center space-x-2 group">
            ...
            <div className="relative bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50">
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b border-gray-800/30 hover:bg-amber-500/5 transition-colors group">
                      <td className="py-4 px-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="font-semibold text-sm text-white group-hover:text-amber-100 transition-colors">Flexible</span>
                        </div>
                      </td>
                      ...
                      <td className="py-4 px-4 text-amber-400 font-bold text-sm">+384.50</td>
                    ...
                    <tr className="border-b border-gray-800/30 hover:bg-amber-500/5 transition-colors group">
                      <td className="py-4 px-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="font-semibold text-sm text-white group-hover:text-amber-100 transition-colors">30-Day</span>
                        </div>
                      </td>
                      ...
                      <td className="py-4 px-4 text-amber-400 font-bold text-sm">+900.00</td>
